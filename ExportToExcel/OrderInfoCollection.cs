...
namespace SfDataGrid_Demo
{
    public class OrderInfoCollection : IDisposable
    {
        ...
        {
            OrdersListDetails = new OrderInfoRepository().GetListOrdersDetails1(20);
            OrdersListDetails1 = new OrderInfoRepository().GetListOrdersDetails2(20);
        }
        ...
        private List<OrderInfo> _ordersListDetails1;

        public List<OrderInfo> OrdersListDetails1
        {
            get { return _ordersListDetails1; }
            set { _ordersListDetails1 = value; }
        }
        public void Dispose()
        {
            Dispose(true);
    ...
    public class OrderInfoRepository
    {
        ...
        /// <returns></returns>
        public List<OrderInfo> GetListOrdersDetails1(int count)
        {
        ...
        /// <param name="count">The count.</param>
        /// <returns></returns>
        public List<OrderInfo> GetListOrdersDetails2(int count)
        {
            List<OrderInfo> ordersDetails = new List<OrderInfo>();
            if (ShipCity.Count == 0)
                SetShipCity();
            for (int i = 20000; i < count + 20000; i++)
            {
                ordersDetails.Add(GetOrder(i));
            }
